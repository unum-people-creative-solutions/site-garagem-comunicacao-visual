        ...
        <div className="grid grid-cols-2 gap-3 md:gap-6 max-w-5xl mx-auto">
          {contactMethods.map((method, index) => (
            <motion.a
              ...
              viewport={{ once: true }}
              className={`group relative ${method.size} p-6 md:p-12 rounded-card border border-white/10 bg-[#0A0A0A] overflow-hidden transition-all duration-500 hover:border-accent active:border-accent hover:shadow-[0_0_40px_rgba(255,215,0,0.1)] active:shadow-[0_0_40px_rgba(255,215,0,0.1)]`}
            >
